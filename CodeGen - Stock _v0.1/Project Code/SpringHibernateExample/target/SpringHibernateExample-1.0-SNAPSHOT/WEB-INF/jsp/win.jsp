<%-- 
    Document   : win
    Created on : Jun 23, 2018, 1:26:16 PM
    Author     : Vishwa
--%>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                            ...
                            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="" data-original-title="Charts">
                                <a class="nav-link" href="machineplayer">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <h1 style="color:#071BA1; text-align:center;"><font style="font-size:50px">Congratulations..!</font></h1>
      <br/>
      ...
      <script type="text/javascript">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4">
                      <img src="<c:url value="/resources/img/win_stars.png"/>">
                  </div>
                  <div class="col-lg-3">
                      <br/>
                      <br/>
                      <img src="<c:url value="/resources/img/win.png"/>">
                      <script type="text/javascript">
                                sleep(1000);
                              </script>
                  ...
                  <div class="col-lg-5">
                      <br/>
                      <br/>
                      <h1 style="color:#029E02; text-align:center;"><font style="font-size:80px"><b>You</b></font></h1>
                      <script type="text/javascript">
                                sleep(1000);
                              </script>
                      <h1 style="color:#029E02; text-align:center;"><font style="font-size:90px"><b>Win..!!</b></font></h1>
