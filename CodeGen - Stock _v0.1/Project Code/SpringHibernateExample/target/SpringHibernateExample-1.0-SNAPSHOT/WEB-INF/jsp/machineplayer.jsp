<%-- 
    Document   : machinepalyer
    Created on : Jun 20, 2018, 11:10:30 AM
    Author     : Vishwa
--%>
...
<head>
  ...
  <script src="<c:url value="/resources/js/js_controllers/TestController.js"/>"></script>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Machine Player</li>
      </ol>
      ...
      <h2 style="color:#5c73f1; text-align:center;">Machine Player</h2>
      <br/>
      <div class="row">
          ...
          <div style="background-color: black" class="col-lg-10">
              <font color="white" id="contentx">
              <p>*****Game Proceeds*****</p>
              <script type="text/javascript">
                sleep(500);
              </script>
