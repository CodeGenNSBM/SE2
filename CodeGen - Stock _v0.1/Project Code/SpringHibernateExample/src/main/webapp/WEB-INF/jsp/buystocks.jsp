<%-- 
    Document   : buystocks
    Created on : Jun 15, 2018, 1:18:42 PM
    Author     : Vishwa
--%>
...
<head>
  ...
  <link href="<c:url value="/resources/css/sb-admin.css"/>" rel="stylesheet">
   <script src="<c:url value="/resources/js/js_controllers/buyController.js"/>"></script>
  <meta charset="utf-8">
    <title></title>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Buy Stocks</li>
      </ol>
      

      <br/>
      <div id="col-12">
          <form class="form-horizontal" id="buyBroker">
<fieldset>
...
<br/>
<label class="col-md-6 control-label" for="selectbasic"><b>Purchasing Stock</b></label>
<br/>
<!-- Text input-->
<div class="form-group">
  <label class="col-md-6 control-label" for="textinput" >Purchasing Stock Amount</label>  
  <div class="col-md-6">
      <input id="st_amount" name="textinput" type="text" placeholder="" class="form-control input-md"  onkeypress="return isNumberKey(event)" required>
  <span class="help-block">purchasing stock amount</span>  
  </div>
</div>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-6 control-label" for="textinput">Net Bill Amount</label>  
  <div class="col-md-6">
      <input id="profit" name="textinput" type="text" placeholder="" class="form-control input-md" readonly>
  <span class="help-block">net bill amount</span>  
  </div>
</div>
<br/>
<!-- Button (Double) -->
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="button1id" name="button1id" class="btn btn-primary">Buy</button>
