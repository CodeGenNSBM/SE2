...
<html lang="en">
  ...
  <script src="<c:url value="/resources/js/js_controllers/BrokerController.js"/>" type="text/javascript"></script>
   </head>
<c:choose>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="form-group">
                      <div class="col-md-8">
                          <button id="refreshStock" class="btn btn-primary">Refresh</button>                          
                      </div>
                  </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="table-responsive" id="eachTable">
                    ...
                    <div class="card-footer small text-muted">Refresh to update the table</div>
                </div>
            </div>
            <!-- /.container-fluid-->
            <!-- /.content-wrapper-->
